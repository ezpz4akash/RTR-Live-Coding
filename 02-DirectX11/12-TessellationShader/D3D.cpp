...
HRESULT initialize(void)
{
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3DCompile() succeeded for hull shader\n");
        fclose(gpFile);
    }
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3D11Device::CreateHullShader() Succeeded\n");
        fclose(gpFile);
    }
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3DCompile() succeeded for domain shader\n");
        fclose(gpFile);
    }
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3D11Device::CreateDomainShader() Succeeded\n");
        fclose(gpFile);
    }
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3D11Device::CreateBuffer() Succeeded for hull shader\n");
        fclose(gpFile);
    }
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3D11Device::CreateBuffer() Succeeded for domain shader\n");
        fclose(gpFile);
    }
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3D11Device::CreateBuffer() Succeeded for pixel shader\n");
        fclose(gpFile);
    }
