...
ID3D11InputLayout *gpID3D11InputLayoutPerVertex = NULL;
...
ID3D11InputLayout *gpID3D11InputLayoutPerFragment = NULL;

// Current active shaders (pointers to one of the pairs above)
...
HRESULT initialize(void)
{
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3DCompile() succeeded for vertex shader per vertex\n");
        fclose(gpFile);
    }
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3D11Device::CreateVertexShader() Succeeded for per vertex\n");
        fclose(gpFile);
    }
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3DCompile() succeeded for pixel shader per vertex\n");
        fclose(gpFile);
    }
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3D11Device::CreatePixelShader() Succeeded for per vertex\n");
        fclose(gpFile);
    }
    ...
    d3d11InputElementDesc_pv[0].Format = DXGI_FORMAT_R32G32B32_FLOAT;
    d3d11InputElementDesc_pv[0].InputSlot = 0;
    d3d11InputElementDesc_pv[0].AlignedByteOffset = 0;
    d3d11InputElementDesc_pv[0].InputSlotClass = D3D11_INPUT_PER_VERTEX_DATA;
    d3d11InputElementDesc_pv[0].InstanceDataStepRate = 0;

    d3d11InputElementDesc_pv[1].SemanticName = "NORMAL";
    d3d11InputElementDesc_pv[1].SemanticIndex = 0;
    d3d11InputElementDesc_pv[1].Format = DXGI_FORMAT_R32G32B32_FLOAT;
    d3d11InputElementDesc_pv[1].InputSlot = 1;
    d3d11InputElementDesc_pv[1].AlignedByteOffset = D3D11_APPEND_ALIGNED_ELEMENT;
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3D11Device::CreateInputLayout() Succeeded for per vertex\n");
        fclose(gpFile);
    }
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3DCompile() succeeded for vertex shader per fragment\n");
        fclose(gpFile);
    }
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3D11Device::CreateVertexShader() Succeeded for per fragment\n");
        fclose(gpFile);
    }
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3DCompile() succeeded for pixel shader per fragment\n");
        fclose(gpFile);
    }
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3D11Device::CreatePixelShader() Succeeded for per fragment\n");
        fclose(gpFile);
    }
    ...
    d3d11InputElementDesc_pf[0].Format = DXGI_FORMAT_R32G32B32_FLOAT;
    d3d11InputElementDesc_pf[0].InputSlot = 0;
    d3d11InputElementDesc_pf[0].AlignedByteOffset = 0;
    d3d11InputElementDesc_pf[0].InputSlotClass = D3D11_INPUT_PER_VERTEX_DATA;
    d3d11InputElementDesc_pf[0].InstanceDataStepRate = 0;

    d3d11InputElementDesc_pf[1].SemanticName = "NORMAL";
    d3d11InputElementDesc_pf[1].SemanticIndex = 0;
    d3d11InputElementDesc_pf[1].Format = DXGI_FORMAT_R32G32B32_FLOAT;
    d3d11InputElementDesc_pf[1].InputSlot = 1;
    d3d11InputElementDesc_pf[1].AlignedByteOffset = D3D11_APPEND_ALIGNED_ELEMENT;
    ...
    {
        gpFile = fopen(szLogFileName, "a+");
        fprintf(gpFile, "D3D11Device::CreateInputLayout() Succeeded for per fragment\n");
        fclose(gpFile);
    }

    // set initial active shaders to per vertex
...
void display(void)
{
    ...
    else if(iLightType == PER_FRAGMENT)
    {
        ...
        gpID3D11InputLayout = gpID3D11InputLayoutPerFragment;
    }
    ...
    else
    {
        ...
        constantBuffer.iLightType = iLightType;
        constantBuffer.La = XMVectorZero();
        constantBuffer.Ld = XMVectorZero();
        constantBuffer.Ls = XMVectorZero();
