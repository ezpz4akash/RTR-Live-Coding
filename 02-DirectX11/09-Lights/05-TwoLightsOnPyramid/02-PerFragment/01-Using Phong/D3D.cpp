...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(
            ...
            TEXT("RTR 6 - Akash Musale: D3D11 Two Lights On Pyramid Using Phong"),  // window name Caption Bar Name
...
HRESULT initialize(void)
{
    ...
    "       phong_ads_light = float3(0.0f, 0.0f, 0.0f);" \
    "       for(int i = 0; i < 2; i++)" \
    "       {" \
    ...
    "           specularLight[i] = (float3)(ls[i] * ks) * pow(max(dot(reflectionVector[i], normalisedViewerVector), 0.0), materialShininess);" \
