...
HRESULT initialize(void)
{
    ...
    const char *pixelShaderSourceCode =
        ...
        "       float3 specularLight = (float3)ls * (float3)Ks * pow(max(dot(reflectionVector, normalisedViewerVector), 0.0), "
        "materialShininess);"
...
#define UPDATE_AND_DRAW_SPHERE(tranX, tranY, tranZ, ambR, ambG, ambB, diffR, diffG, diffB, specR, specG, specB, shin)                      \
    ...
    // Emerald
    UPDATE_AND_DRAW_SPHERE(1.5f, 14.0f, 0.0f, 0.0215f, 0.1745f, 0.0215f, 0.07568f, 0.61424f, 0.07568f, 0.633f, 0.727811f, 0.633f,
                           0.6f * 128);
    ...
    // Obsidian
    UPDATE_AND_DRAW_SPHERE(1.5f, 9.0f, 0.0f, 0.05375f, 0.05f, 0.06625f, 0.18275f, 0.17f, 0.22525f, 0.332741f, 0.328634f, 0.346435f,
                           0.3f * 128);

    // Pearl
    UPDATE_AND_DRAW_SPHERE(1.5f, 6.5f, 0.0f, 0.25f, 0.20725f, 0.20725f, 1.0f, 0.829f, 0.829f, 0.296648f, 0.296648f, 0.296648f,
                           0.088f * 128);

    // Ruby
    UPDATE_AND_DRAW_SPHERE(1.5f, 4.0f, 0.0f, 0.1745f, 0.01175f, 0.01175f, 0.61424f, 0.04136f, 0.04136f, 0.727811f, 0.626959f, 0.626959f,
                           0.6f * 128);

    // Turquoise
    UPDATE_AND_DRAW_SPHERE(1.5f, 1.5f, 0.0f, 0.1f, 0.18725f, 0.1745f, 0.396f, 0.74151f, 0.69102f, 0.297254f, 0.30829f, 0.306678f,
                           0.1f * 128);

    // ===== 2nd Column (6 spheres) =====
    // Brass
    UPDATE_AND_DRAW_SPHERE(7.5f, 14.0f, 0.0f, 0.329412f, 0.223529f, 0.027451f, 0.780392f, 0.568627f, 0.113725f, 0.992157f, 0.941176f,
                           0.807843f, 0.21794872f * 128);

    // Bronze
    UPDATE_AND_DRAW_SPHERE(7.5f, 11.5f, 0.0f, 0.2125f, 0.1275f, 0.054f, 0.714f, 0.4284f, 0.18144f, 0.393548f, 0.271906f, 0.166721f,
                           0.2f * 128);
    ...
    // Copper
    UPDATE_AND_DRAW_SPHERE(7.5f, 6.5f, 0.0f, 0.19125f, 0.0735f, 0.0225f, 0.7038f, 0.27048f, 0.0828f, 0.256777f, 0.137622f, 0.086014f,
                           0.1f * 128);

    // Gold
    UPDATE_AND_DRAW_SPHERE(7.5f, 4.0f, 0.0f, 0.24725f, 0.1995f, 0.0745f, 0.75164f, 0.60648f, 0.22648f, 0.628281f, 0.555802f, 0.366065f,
                           0.4f * 128);

    // Silver
    UPDATE_AND_DRAW_SPHERE(7.5f, 1.5f, 0.0f, 0.19225f, 0.19225f, 0.19225f, 0.50754f, 0.50754f, 0.50754f, 0.508273f, 0.508273f, 0.508273f,
                           0.4f * 128);
    ...
    // Cyan
    UPDATE_AND_DRAW_SPHERE(13.5f, 11.5f, 0.0f, 0.0f, 0.1f, 0.06f, 0.0f, 0.50980392f, 0.50980392f, 0.50196078f, 0.50196078f, 0.50196078f,
                           0.25f * 128);
