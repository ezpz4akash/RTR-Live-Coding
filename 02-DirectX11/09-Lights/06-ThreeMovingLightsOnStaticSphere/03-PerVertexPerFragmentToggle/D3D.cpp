...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(
            ...
            TEXT("RTR 6 - Akash Musale: D3D11 Three Moving Lights On Static Sphere Per Vertex Per Fragment Toggle"),  // window name Caption Bar Name
...
HRESULT initialize(void)
{
    ...
    "           float3 specularLight = (float3)Ls[i] * (float3)Ks * pow(max(dot(reflectionVector, viewerVector), 0.0f), materialShininess);" \
    ...
    hr = D3DCompile(
            vertexShaderSourceCodePerFragment,
            lstrlenA(vertexShaderSourceCodePerFragment) + 1,
            "VS_PER_FRAGMENT",
            NULL,
            D3D_COMPILE_STANDARD_FILE_INCLUDE,
            "main",
            ...
            0,
            0,
            &pID3DBlob_vertexShaderCodePerFragment,
            &pID3DBlob_error
        );
    ...
    hr = gpID3D11Device->CreateVertexShader(
                            pID3DBlob_vertexShaderCodePerFragment->GetBufferPointer(),
                            pID3DBlob_vertexShaderCodePerFragment->GetBufferSize(),
                            NULL,
    ...
    hr = D3DCompile(
            pixelShaderSourceCodePerFragment,
            lstrlenA(pixelShaderSourceCodePerFragment) + 1,
            "PS_PER_FRAGMENT",
            NULL,
            D3D_COMPILE_STANDARD_FILE_INCLUDE,
            "main",
            ...
            0,
            0,
            &pID3DBlob_pixelShaderCodePerFragment,
            &pID3DBlob_error
        );
    ...
    hr = gpID3D11Device->CreatePixelShader(
                            pID3DBlob_pixelShaderCodePerFragment->GetBufferPointer(),
                            pID3DBlob_pixelShaderCodePerFragment->GetBufferSize(),
                            NULL,
