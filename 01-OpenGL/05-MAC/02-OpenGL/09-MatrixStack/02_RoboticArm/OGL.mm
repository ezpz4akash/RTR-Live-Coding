...
@implementation GLView
{
    ...
    GLfloat materialEmission[3];
    GLfloat materiaShininess;
}
...
-(int) initialize
{
   ...
   // Step 1 Write the shader source code
    ...
    lightSpecular[0] = 0.0f; lightSpecular[1] = 0.0f; lightSpecular[2] = 0.0f; lightSpecular[3] = 1.0f;
    lightPosition = vec4(0.0f, 3.0f, 5.0f, 1.0f);
    
    // Initialize material properties
    materialAmbient[0] = 0.5f; materialAmbient[1] = 0.35f; materialAmbient[2] = 0.05f; materialAmbient[3] = 1.0f;
    materialDiffuse[0] = 0.5f; materialDiffuse[1] = 0.35f; materialDiffuse[2] = 0.05f; materialDiffuse[3] = 1.0f;
    materialSpecular[0] = 0.0f; materialSpecular[1] = 0.0f; materialSpecular[2] = 0.0f; materialSpecular[3] = 1.0f;
    materialEmission[0] = 0.5f; materialEmission[1] = 0.35f; materialEmission[2] = 0.05f;
    materiaShininess = 1.0f;
...
-(void)display
{
    ...
    std::stack <mat4> modelMatrixStack;
    ...
    glUniform3fv(materialEmissionUniform, 1, materialEmission);
    ...
    modelMatrixStack.push(modelMatrix);
        modelMatrix = modelMatrix * vmath::scale(2.1f, 0.6f, 1.0f);
    ...
    // draw wrist
    modelMatrix = modelMatrix * vmath::translate(1.0f, 0.0f, 0.0f);
    modelMatrix = modelMatrix * vmath::rotate((GLfloat)wristZ, 0.0f, 0.0f, 1.0f);
    modelMatrix = modelMatrix * vmath::rotate((GLfloat)wristX, 1.0f, 0.0f, 0.0f);
    modelMatrix = modelMatrix * vmath::translate(0.25f, 0.0f, 0.0f);
    modelMatrix = modelMatrix * vmath::scale(0.525f, 0.15f, 0.25f);
    glUniformMatrix4fv(modelMatrixUniform, 1, GL_FALSE, modelMatrix);
    glDrawElements(GL_TRIANGLES, [sphere getNumberOfSphereElements], GL_UNSIGNED_SHORT, 0);
