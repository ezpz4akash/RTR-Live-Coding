...
@implementation GLView
{
    ...
    // rotation angles
    GLfloat gldAngleTriangle;
    GLfloat gldAngleRectangle;
}
...
-(void)display
{
  ...
  // transformations
    ...
    rotationMatrix = vmath::rotate(gldAngleTriangle, 0.0f, 1.0f, 0.0f);
    ...
    translationMatrix = vmath::translate(1.5f, 0.0f, -6.0f);
    rotationMatrix = vmath::rotate(gldAngleRectangle, 1.0f, 0.0f, 0.0f);
...
{
    //code
    gldAngleTriangle = gldAngleTriangle + 2.0f;
    if (gldAngleTriangle >= 360.0f)
    {
        gldAngleTriangle = 0.0f;
    }

    gldAngleRectangle = gldAngleRectangle - 2.0f;
    if (gldAngleRectangle <= 0)
    {
        gldAngleRectangle = 360.0f;
    }
