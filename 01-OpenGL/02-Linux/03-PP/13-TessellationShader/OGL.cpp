...
int main(void){
    ...
    */
    ...
    // Set window title
    XStoreName(gpDisplay, window, "Akash Musale - RTR6 - 2DRotation - BW - Triangle");
...
void display(void){
    ...
    glUseProgram(shaderProgramObject);
    {
        ...
        mat4 modelViewProjectionMatrix = mat4::identity();
        {
            ...
            char str[255];
            sprintf(str, "RTR 6 - Akash Musale - Tesselation Shader : No Of Line Segments = %d", uiNoOfLineSegments);
