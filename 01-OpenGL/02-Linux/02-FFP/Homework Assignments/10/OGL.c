...
GLboolean drawTriangle = True, drawCircle = True, drawSquare = True, drawGraph = True, drawCircleUsingPoints = True;
...
int main(void){
    ...
    // Set window title
    XStoreName(gpDisplay, window, "Akash Musale - RTR6 - Graph, Circle, Triangle, Square");
