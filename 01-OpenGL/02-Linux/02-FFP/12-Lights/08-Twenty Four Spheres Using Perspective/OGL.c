...
int main(void){
    ...
    // Set window title
    XStoreName(gpDisplay, window, "Akash Musale - RTR6 - Lights - Twenty Four Spheres Using Perspective");
...
void draw24Spheres(void){
    fprintf(gpFile, "lightPosition : %f %f %f\n", lightPosition[0], lightPosition[1], lightPosition[2]);
    // variable declarations
