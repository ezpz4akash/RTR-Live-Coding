...
int main(void){
    ...
    // Set window title
    XStoreName(gpDisplay, window, "Akash Musale - RTR6 - Lights - Twenty Four Spheres Using Trigonometry");
...
void display(void){
    ...
    if(keyPressed == 1){
        ...
        RotationMatrixX[5]   = cos(angleForXRotation);
        RotationMatrixX[6]   = sin(angleForXRotation);
        RotationMatrixX[7]   = 0.0f;
        RotationMatrixX[8]   = 0.0f;
        RotationMatrixX[9]   = -sin(angleForXRotation);
        RotationMatrixX[10]  = cos(angleForXRotation);
        ...
        RotationMatrixY[0]   = cos(angleForYRotation);
        RotationMatrixY[1]   = 0.0f;
        RotationMatrixY[2]   = -sin(angleForYRotation);
        RotationMatrixY[3]   = 0.0f;
        RotationMatrixY[4]   = 0.0f;
        RotationMatrixY[5]   = 1.0f;
        RotationMatrixY[6]   = 0.0f;
        RotationMatrixY[7]   = 0.0f;
        RotationMatrixY[8]   = sin(angleForYRotation);
        RotationMatrixY[9]   = 0.0f;
        RotationMatrixY[10]  = cos(angleForYRotation);
        ...
        RotationMatrixZ[0]   = cos(angleForZRotation);
        RotationMatrixZ[1]   = sin(angleForZRotation);
        RotationMatrixZ[2]   = 0.0f;
        RotationMatrixZ[3]   = 0.0f;
        RotationMatrixZ[4]   = -sin(angleForZRotation);
        RotationMatrixZ[5]   = cos(angleForZRotation);
