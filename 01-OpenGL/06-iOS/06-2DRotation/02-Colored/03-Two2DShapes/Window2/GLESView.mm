...
-(void)display
{
    ...
    glUseProgram(shaderProgramObject);
    {
        // Transformations for triangle
        {
            ...
            vmath::mat4 rotationMatrix = vmath::rotate(angle_triangle, 0.0f, 1.0f, 0.0f);
            vmath::mat4 modelViewMatrix = translationMatrix * rotationMatrix;
        ...
        {
            vmath::mat4 translationMatrix = vmath::translate(1.5f, 0.0f, -6.0f);
            vmath::mat4 rotationMatrix = vmath::rotate(angle_rectangle, 1.0f, 0.0f, 0.0f);
            vmath::mat4 modelViewMatrix = translationMatrix * rotationMatrix;
            vmath::mat4 modelViewProjectionMatrix = perspectiveProjectionMatrix * modelViewMatrix;
            glUniformMatrix4fv(mvpMatrixUniform, 1, GL_FALSE, (const float*)modelViewProjectionMatrix);
        }
...
-(void)myupdate
{
    angle_triangle += 10.01f;
    angle_rectangle += 10.01f;
}
