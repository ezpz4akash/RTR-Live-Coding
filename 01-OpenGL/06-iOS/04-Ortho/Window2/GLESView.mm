...
-(void)resize:(int)width :(int)height
{
    ...
    if(width <= height)
        orthographicProjectionMatrix = vmath::ortho(-1.0f, 1.0f, -1.0f / aspectRatio, 1.0f / aspectRatio, -10.0f, 10.0f);
    else
        orthographicProjectionMatrix = vmath::ortho(-aspectRatio, aspectRatio, -1.0f, 1.0f, -10.0f, 10.0f);
}
...
-(void)display
{
    ...
    glUseProgram(shaderProgramObject);
    {
        ...
        // MVP = Ortho * Identity (no translation needed for ortho)
