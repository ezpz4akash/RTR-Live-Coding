...
-(int)initialize
{
    ...
    // Index array for 2 triangles forming a rectangle
    const GLuint rectangle_indices[] = {
        0, 1, 3,   // First triangle (top-right, top-left, bottom-right)
        3, 1, 2    // Second triangle (bottom-right, top-left, bottom-left)
    };
    ...
    glBindVertexArray(vao);
    {
        ...
        // DO NOT unbind GL_ELEMENT_ARRAY_BUFFER here - it's part of VAO state
    }
...
-(void)display
{
    ...
    glUseProgram(shaderProgramObject);
    {
        ...
        glBindVertexArray(vao);
        {
            // Draw the rectangle using indexed drawing
