...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow){
    ...
    hWnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("RTR 6 - Akash Musale - Kundali"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, (screenWidth - WIN_WIDTH) / 2, (screenHeight  - WIN_HEIGHT) / 2, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
    ghWnd = hWnd;
...
void display(void){
    ...
    glBegin(GL_LINE_LOOP);
        glVertex3f(0.0f, leftTop.y, 0.0f);
        glVertex3f(rightTop.x, 0.0f, 0.0f);
        glVertex3f(0.0f, rightBottom.y, 0.0f);
        glVertex3f(leftTop.x, 0.0f, 0.0f);
    glEnd();
