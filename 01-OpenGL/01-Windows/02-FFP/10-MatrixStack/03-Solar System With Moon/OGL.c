...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow){
    ...
    hWnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("RTR 6 - Akash Musale - Sun Earth Moon"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, (screenWidth - WIN_WIDTH) / 2, (screenHeight  - WIN_HEIGHT) / 2, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
    ghWnd = hWnd;
...
void display(void){
    ...
    glPushMatrix();
        ...
        // Translate : Earth is at some distance from sun
        glTranslatef(4.0f, 0.0f, 0.0f);

        // Adjust the poles of sphere of earth
        glRotatef(90.0f, 1.0f, 0.0f, 0.0f);

        // Rotation around itself - spin
        ...
        // Draw earth
        gluSphere(quadric, 0.50, 30, 10);

        // Translate : Moon is at some distance from Earth
