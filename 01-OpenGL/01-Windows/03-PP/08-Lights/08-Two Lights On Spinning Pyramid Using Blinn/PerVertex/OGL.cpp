...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow){
    ...
    hWnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("RTR 6 - Akash Musale - Lights - TwoLightsOnSpinningPyramidUsingBlinnPerVertex"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, (screenWidth - WIN_WIDTH) / 2, (screenHeight  - WIN_HEIGHT) / 2, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
    ghWnd = hWnd;
...
int initialize(void){
    ...
    */
    ...
    const GLchar *vertexShaderSourceCode = 
        ...
        "out vec4 out_phong_ads_Light_blinn;\n" \
        "void main(void)\n" \
        "{\n" \
        "   if(uLKeyPressed == 1)\n" \
        "   {\n" \
        ...
        "   else\n" \
        "   {\n" \
        "       out_phong_ads_Light_blinn = vec4(1.0, 1.0, 1.0, 1.0);\n" \
        "   }\n" \
    ...
    */
    ...
    const GLchar *fragmentShaderSourceCode = 
        "#version 460 core\n" \
        "in vec4 out_phong_ads_Light_blinn;\n" \
        "out vec4 FragColor;\n" \
        "void main(void)\n" \
        "{\n" \
