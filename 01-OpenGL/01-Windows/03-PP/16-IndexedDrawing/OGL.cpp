...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow){
    ...
    hWnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("RTR 6 - Akash Musale - IndexDrawing"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, (screenWidth - WIN_WIDTH) / 2, (screenHeight  - WIN_HEIGHT) / 2, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
    ghWnd = hWnd;
...
int initialize(void){
    ...
    */
    ...
    // Rectangle
    {
        ...
        const GLuint rectangle_indices[] = {
            0, 1, 3,
            3, 1, 2
        };
        ...
        glBindVertexArray(vao_rectangle);
        {
            ...
            {
                glGenBuffers(1, &vbo_index_rectangle);
                glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, vbo_index_rectangle);
                {
                    glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(rectangle_indices), rectangle_indices, GL_STATIC_DRAW);
                }
                //glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, 0); // DO NOT UNBIND, INDEXES ARE NOT RECORDED AS PART OF VAO
            }
        }
...
void uninitialize(void){
    ...
    if(vbo_index_rectangle){
        glDeleteBuffers(1, &vbo_index_rectangle);
        vbo_index_rectangle = 0;
    }
