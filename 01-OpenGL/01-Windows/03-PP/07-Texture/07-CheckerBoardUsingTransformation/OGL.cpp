...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow){
    ...
    hWnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("RTR 6 - Akash Musale - Texture - CheckerboardWithTransformation"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, (screenWidth - WIN_WIDTH) / 2, (screenHeight  - WIN_HEIGHT) / 2, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
    ghWnd = hWnd;
...
void display(void){
    ...
    glUseProgram(shaderProgramObject);
    {
        ...
        mat4 rotationMatrix = mat4::identity();
        {
            ...
            // Prepare transformation matrices
            translationMatrix = vmath::translate(1.0f, 0.0f, -5.5f);

            rotationMatrix = vmath::rotate(40.0f, 0.0f, 1.0f, 0.0f);
