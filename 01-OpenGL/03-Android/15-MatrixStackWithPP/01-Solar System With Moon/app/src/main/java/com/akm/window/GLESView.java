    ...
    private void display()
    {
        ...
        GLES32.glUseProgram(shaderProgramObject);
        {
            ...
            GLES32.glBindVertexArray(vao_sphere[0]);
            {
                ...
                float earthTransform[] = new float[16];
                Matrix.setIdentityM(earthTransform, 0);
                Matrix.multiplyMM(earthTransform, 0, earthTransform, 0, modelViewMatrix, 0);
                Matrix.multiplyMM(earthTransform, 0, earthTransform, 0, rotationMatrix, 0);
                Matrix.multiplyMM(earthTransform, 0, earthTransform, 0, translationMatrix, 0);
                Matrix.multiplyMM(earthTransform, 0, earthTransform, 0, scaleMatrix, 0);
                Matrix.multiplyMM(modelViewProjectionMatrix, 0, perspectiveProjectionMatrix, 0, earthTransform, 0);
                GLES32.glBindBuffer(GLES32.GL_ELEMENT_ARRAY_BUFFER, vbo_sphere_element[0]);
                GLES32.glUniformMatrix4fv(mvpMatrixUniform, 1, false, modelViewProjectionMatrix, 0);
                ...
                float moonTransform[] = new float[16];
                Matrix.setIdentityM(moonTransform, 0);
                Matrix.multiplyMM(moonTransform, 0, moonTransform, 0, earthTransform, 0);
                Matrix.multiplyMM(moonTransform, 0, moonTransform, 0, rotationMatrix, 0);
                Matrix.multiplyMM(moonTransform, 0, moonTransform, 0, translationMatrix, 0);
                Matrix.multiplyMM(moonTransform, 0, moonTransform, 0, scaleMatrix, 0);
                Matrix.multiplyMM(modelViewProjectionMatrix, 0, perspectiveProjectionMatrix, 0, moonTransform, 0);
                GLES32.glBindBuffer(GLES32.GL_ELEMENT_ARRAY_BUFFER, vbo_sphere_element[0]);
                GLES32.glUniformMatrix4fv(mvpMatrixUniform, 1, false, modelViewProjectionMatrix, 0);
                GLES32.glVertexAttrib4f(MyAttributes.AMC_ATTRIBUTE_COLOR, 1.0f, 1.0f, 1.0f, 1.0f);
                GLES32.glDrawElements(GLES32.GL_TRIANGLES, numElements, GLES32.GL_UNSIGNED_SHORT, 0);
            }
            GLES32.glBindVertexArray(0);
        }
