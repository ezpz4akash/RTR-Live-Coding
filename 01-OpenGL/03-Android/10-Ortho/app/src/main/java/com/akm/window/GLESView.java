...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    private void resize(int width, int height)
    {
        ...
        if(width <= height)
            Matrix.orthoM(orthographicProjectionMatrix, 0, -1.0f, 1.0f, -1.0f / aspectRatio, 1.0f / aspectRatio, -10.0f, 10.0f);
        else
            Matrix.orthoM(orthographicProjectionMatrix, 0, -aspectRatio, aspectRatio, -1.0f, 1.0f, -10.0f, 10.0f);
    }
