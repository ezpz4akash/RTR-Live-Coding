...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    private int vboRectangleColor[] = new int[1];
    ...
    private int initialize(GL10 gl)
    {
        ...
        //Triangle vertices
        {
            ...
            //Setup vaoTriangle and vboTrianglePosition
            ...
            GLES32.glBindVertexArray(vaoTriangle[0]);
            {
                ...
                {
                    java.nio.ByteBuffer byteBuffer = java.nio.ByteBuffer.allocateDirect(triangleColors.length * 4);
                    byteBuffer.order(java.nio.ByteOrder.nativeOrder());
                    java.nio.FloatBuffer colorBuffer = byteBuffer.asFloatBuffer();
        ...
        //Rectangle vertices
        {
            ...
            //Setup vaoRectangle and vboRectanglePosition
            ...
            GLES32.glBindVertexArray(vaoRectangle[0]);
            {
                ...
                {
                    java.nio.ByteBuffer byteBuffer = java.nio.ByteBuffer.allocateDirect(rectangleVertices.length * 4);
                    byteBuffer.order(java.nio.ByteOrder.nativeOrder());
                    java.nio.FloatBuffer verticesBuffer = byteBuffer.asFloatBuffer();
                    ...
                    GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, rectangleVertices.length * 4, verticesBuffer, GLES32.GL_STATIC_DRAW);
                    GLES32.glVertexAttribPointer(MyAttributes.AMC_ATTRIBUTE_POSITION, 3, GLES32.GL_FLOAT, false, 0, 0);
                    GLES32.glEnableVertexAttribArray(MyAttributes.AMC_ATTRIBUTE_POSITION);
                }
                GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, 0);

                GLES32.glGenBuffers(1, vboRectangleColor, 0);
                GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, vboRectangleColor[0]);
                {
                    java.nio.ByteBuffer byteBuffer = java.nio.ByteBuffer.allocateDirect(rectangleColors.length * 4);
                    byteBuffer.order(java.nio.ByteOrder.nativeOrder());
                    java.nio.FloatBuffer colorBuffer = byteBuffer.asFloatBuffer();
                    ...
                    GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, rectangleColors.length * 4, colorBuffer, GLES32.GL_STATIC_DRAW);
                    GLES32.glVertexAttribPointer(MyAttributes.AMC_ATTRIBUTE_COLOR, 3, GLES32.GL_FLOAT, false, 0, 0);
                    GLES32.glEnableVertexAttribArray(MyAttributes.AMC_ATTRIBUTE_COLOR);
                }
                GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, 0);
    ...
    private void uninitialize()
    {
        ...
        if(vboRectangleColor[0] != 0)
        {
            GLES32.glDeleteBuffers(1, vboRectangleColor, 0);
            vboRectangleColor[0] = 0;
        }
        if(vaoRectangle[0] != 0)
        {
