        ...
        //Rectangle vertices
        {
            ...
            GLES32.glBindVertexArray(vaoRectangle[0]);
            {
                ...
                GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, vboRectangleColor[0]);
                {
                    ...
                    byteBuffer.order(java.nio.ByteOrder.nativeOrder());
                    java.nio.FloatBuffer colorsBuffer = byteBuffer.asFloatBuffer();

                    colorsBuffer.put(rectangleColors);
                    colorsBuffer.position(0);

                    GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, rectangleColors.length * 4, colorsBuffer, GLES32.GL_STATIC_DRAW);
