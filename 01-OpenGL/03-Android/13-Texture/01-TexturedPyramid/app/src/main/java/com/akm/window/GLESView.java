...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    private int vboPyramidTexcoord[] = new int[1];
    ...
    private int initialize(GL10 gl)
    {
        ...
        //Pyramid vertices
        {
            ...
            GLES32.glBindVertexArray(vaoPyramid[0]);
            {
                ...
                GLES32.glGenBuffers(1, vboPyramidTexcoord, 0);
                GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, vboPyramidTexcoord[0]);
                {
                    GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, pyramidTexcoordsBuffer.capacity() * 4, pyramidTexcoordsBuffer, GLES32.GL_STATIC_DRAW);
    ...
    private void uninitialize()
    {
        ...
        if(vboPyramidTexcoord[0] != 0)
        {
            GLES32.glDeleteBuffers(1, vboPyramidTexcoord, 0);
            vboPyramidTexcoord[0] = 0;
        }
        if(stoneTexture != 0)
        {
            int[] textures = new int[1];
            textures[0] = stoneTexture;
