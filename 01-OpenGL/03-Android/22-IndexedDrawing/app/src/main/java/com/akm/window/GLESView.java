...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    private int vboRectangleIndices[] = new int[1];
    ...
    private int initialize(GL10 gl)
    {
        ...
        //rectangle vertices
        {
            ...
            final int rectangleIndices[] = new int[]
            {
                0, 1, 3,
                3, 1, 2
            };

            //Setup vao and vboRectanglePosition
            ...
            GLES32.glBindVertexArray(vao[0]);
            {
                ...
                //Indices
                GLES32.glGenBuffers(1, vboRectangleIndices, 0);
                GLES32.glBindBuffer(GLES32.GL_ELEMENT_ARRAY_BUFFER, vboRectangleIndices[0]);
                {
                    ByteBuffer byteBuffer = ByteBuffer.allocateDirect(rectangleIndices.length * 4);
                    byteBuffer.order(ByteOrder.nativeOrder());
                    java.nio.IntBuffer indicesBuffer = byteBuffer.asIntBuffer();

                    indicesBuffer.put(rectangleIndices);
                    indicesBuffer.position(0);

                    GLES32.glBufferData(GLES32.GL_ELEMENT_ARRAY_BUFFER, rectangleIndices.length * 4, indicesBuffer, GLES32.GL_STATIC_DRAW);
                }
            }
