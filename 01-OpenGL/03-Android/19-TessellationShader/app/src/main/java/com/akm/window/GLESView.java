...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    private boolean longPressed = true;
    ...
    private int initialize(GL10 gl)
    {
        ...
        GLES32.glGetShaderiv(tesselationControlShaderObject, GLES32.GL_COMPILE_STATUS, iStatus, 0);
        if(iStatus[0] == GLES32.GL_FALSE)
        {
            ...
            if(iInfoLogLength[0] > 0)
            {
                ...
                System.out.println("AKM: tesselationControl Shader Compilation Log = " + szInfoLog);
                uninitialize();
                System.exit(0);
            }
        }
        ...
        GLES32.glGetShaderiv(tesselationEvaluationShaderObject, GLES32.GL_COMPILE_STATUS, iStatus, 0);
        if(iStatus[0] == GLES32.GL_FALSE)
        {
            ...
            if(iInfoLogLength[0] > 0)
            {
                ...
                System.out.println("AKM: tesselationEvaluationShader Compilation Log = " + szInfoLog);
                uninitialize();
                System.exit(0);
            }
        }
        ...
        GLES32.glBindAttribLocation(shaderProgramObject, MyAttributes.AMC_ATTRIBUTE_POSITION, "vPosition");
        ...
        //Line vertices
        {
            ...
            GLES32.glBindVertexArray(vao[0]);
            {
                ...
                {
                    java.nio.ByteBuffer byteBuffer = java.nio.ByteBuffer.allocateDirect(lineVertices.length * 4);
