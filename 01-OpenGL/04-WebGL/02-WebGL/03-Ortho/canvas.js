...
function resize(){
    ...
    //mat4.perspective(orthoProjectionMatrix, 45.0, parseFloat(canvas.width) / parseFloat(canvas.height), 0.1, 100.0);
    mat4.ortho(orthoProjectionMatrix, -1.0, 1.0, -1.0, 1.0, 0.1, 100.0);
}
...
function display(){
    ...
    mat4.multiply(modelViewProjectionMatrix, orthoProjectionMatrix, modelViewMatrix);
